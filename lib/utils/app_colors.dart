...
class AppColor {
  ...
  static const primary = Color(0xFFFA8117);
  static const blackColor = Colors.black;
  static const whiteColor = Colors.white;
  static const lightOrangeColor = Color(0xFFFFEFD7);
  static const orangeBorderColor = Color(0xFFFFD9B8);
  static const textFieldBorderColor = Color(0xFFD0D5DD);
  static const greyText = Color(0xFF686868);
  static const screenBgColor = Color(0xFFEFF3F8);
  static const tabBgColor = Color(0xFFF9F9F9);
  static const tabTextColor = Color(0xFF1E1F4B);
  static const redColor = Color(0xFFFF2C2C);
